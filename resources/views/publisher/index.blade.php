...
@section('main-content')
  <div class="row mb-4">
    ...
    <div class="col-lg-6 col-12 mb-md-4 mb-sm-4 mb-xs-4">
      <div class="card">
  ...
  <div class="row my-4">
    ...
    <div class="col-12 col-lg-3 mt-xs-4 mt-0">
    <div class="card">
  ...
  <div class="row my-4">
    <div class="col-12 col-lg-3 mb-xs-4">
    <div class="card">
      <div class="card-header">
      <h6 class="text-sm">Sales Overview <span class="text-xs">(Current Month)</span></h6>
      </div>
    ...
    <div class="tab-content mt-3" id="mainTabContent">
      ...
      <div class="card">
        ...
        <div class="tab-content mt-3" id="linkTabContent">
          ...
          <div class="tab-pane fade" id="shorttrackingLink" role="tabpanel" aria-labelledby="shorttrackingLink-tab">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body border-top">
            <div class="d-flex flex-column">
              <a class="text-sm text-primary" href="https://app.theaffilo.com/short/pdqKVMGnF1" target="_blank"
              style="word-break: break-all;">
