<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl fixed-start" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="#">
      <img src="{{asset('AdminDashboard/assets/img/logo-ct-dark.png')}}" class="navbar-brand-img h-100" alt="main_logo">
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-toggle="collapse" href="#publishersMenu" role="button"
          aria-expanded="false" aria-controls="publishersMenu">
          <div
        ...
        <div class="collapse" id="publishersMenu">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item">
              <a class="nav-link" href="../pages/all-advertisers.html">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../pages/add-advertiser.html">
                <span class="sidenav-mini-icon"> + </span>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-toggle="collapse" href="#advertiserMenu" role="button"
        ...
        <div class="collapse" id="advertiserMenu">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item">
              <a class="nav-link" href="../pages/all-advertisers.html">
                <span class="sidenav-mini-icon"> </span>
            ...
            <li class="nav-item">
              <a class="nav-link" href="../pages/add-advertiser.html">
                <span class="sidenav-mini-icon"> + </span>
                <span class="sidenav-normal"> Add Advertiser </span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-toggle="collapse" href="#approvalMenu" role="button" aria-expanded="false"
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-toggle="collapse" href="#creativesMenu" role="button"
        ...
        <div class="collapse" id="creativesMenu">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item">
              <a class="nav-link" href="../pages/all-advertisers.html">
                <span class="sidenav-mini-icon"> </span>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-toggle="collapse" href="#transactionsMenu" role="button"
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-toggle="collapse" href="#usersMenu" role="button" aria-expanded="false"
